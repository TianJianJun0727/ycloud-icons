...
The following is a set of guidelines for contributing to YCloud. Feel free to propose changes to this document in a pull request.
...
Please make sure you follow the icon guidelines, that should be followed to keep quality and consistency when making icons for YCloud.

Read it here: [ICON_GUIDELINES](https://tianjianjun0727.github.io/ycloud-icons/contribute/icon-design-guide).

#### YCloud Studio

For formatting and adjusting SVG icons, use the YCloud Studio workflow once the YCloud-hosted editor is available. It is intended to provide a web-based SVG editor for creating new icons or modifying existing ones in the YCloud style.

#### Editor guides

Here you can find instructions on how to implement the guidelines with different vector graphics editors:

##### [Adobe Illustrator Guide](https://tianjianjun0727.github.io/ycloud-icons/contribute/illustrator-guide)

You can also [download an Adobe Illustrator template](https://tianjianjun0727.github.io/ycloud-icons/templates/illustrator_template.ai).

##### [Inkscape Guide](https://tianjianjun0727.github.io/ycloud-icons/contribute/inkscape-guide)

##### [Figma Guide](https://tianjianjun0727.github.io/ycloud-icons/contribute/figma-guide)

##### [Affinity Designer Guide](https://tianjianjun0727.github.io/ycloud-icons/contribute/affinity-designer-guide)
...
If the icon has not already been requested, [create an icon request issue](https://github.com/TianJianJun0727/ycloud-icons/issues/new?assignees=&labels=%F0%9F%99%8C+icon+request&projects=&template=01_icon_request.yml) and add as much information as possible.

### Icon Requests from Feather

If you are a designer who wants to contribute to YCloud but you don't know what icons to work on, then have a look at the Requests from Feather. All open, unfinished and valid requests can be found in [Feather Icon Requests](https://github.com/TianJianJun0727/ycloud-icons/issues/119).
...
The configured directory for workspaces is the [packages](https://github.com/TianJianJun0727/ycloud-icons/tree/main/packages) directory, located in the root directory. There you will find all the current packages from ycloud.
There are more workspaces defined, see [`pnpm-workspace.yaml`](https://github.com/TianJianJun0727/ycloud-icons/blob/main/pnpm-workspace.yaml).

> Note: One package is not managed by pnpm: **ycloud-flutter**, this package is written in Dart and uses pub for publishing.
...
pnpm @ycloud-web/icons-preact test:watch
```
...
The tianjianjun0727.github.io/ycloud-icons website is using [vitepress](https://vitepress.dev/) to generate the static website. The markdown files are located in the docs directory.
...
All the icons of YCloud in SVG format. These will be used as source for all the packages and other distributions for the YCloud icons.

### Packages

Includes all the (npm) packages of ycloud.
...
The documentation files are located in the [docs](https://github.com/TianJianJun0727/ycloud-icons/tree/main/docs) directory. All these markdown files will be loaded in the build of the tianjianjun0727.github.io/ycloud-icons website.

Feel free to write, adjust or add new markdown files to improve our documentation.

## Support

If you need any help or have problems with you contribution. Please don't hesitate to contact the YCloud Community, you can find us on [Github](https://github.com/TianJianJun0727/ycloud-icons) and [Discord](https://discord.gg/EH6nSts).

## Credits

Thank you to all the people who already contributed to YCloud!

<a href="https://github.com/TianJianJun0727/ycloud-icons/graphs/contributors">
<img src="https://opencollective.com/ycloud-icons/contributors.svg?width=800" /></a>
