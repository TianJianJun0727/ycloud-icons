...
This guide describes how to use the Affinity Designer template for YCloud.
...
1. Download and open the [Affinity Designer template](https://github.com/TianJianJun0727/ycloud-icons/blob/main/docs/public/templates/affinity_designer.aftemplate).
2. Follow the [Icon Design Principles](icon-design-guide.md) while you use the template (to ensure integrity with the YCloud icon pack).
