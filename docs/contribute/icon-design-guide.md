---
description: Guidelines and best practices for designing icons for the YCloud icon library.
---

# Icon Design Guide

Guidelines and best practices for designing icons for the YCloud icon library.

## Icon Design Principles

Here are rules that should be followed to keep quality and consistency when making icons for YCloud.
...
We recommend to use the YCloud Studio workflow to tidy paths to 3 points of precision once the YCloud-hosted editor is available.
