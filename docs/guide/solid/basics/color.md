...
::: sandpack {template=vite-solid showTabs=false editorHeight=295 editorWidthPercentage=60 dependencies="@ycloud-web/icons-solid"}

```tsx ./App.tsx [active]
import Smile from '@ycloud-web/icons-solid/icons/smile';
...
::: sandpack {template=vite-solid editorHeight=320 editorWidthPercentage=60 dependencies="@ycloud-web/icons-solid"}

```tsx ./Button.tsx [active]
import ThumbsUp from '@ycloud-web/icons-solid/icons/thumbs-up';
