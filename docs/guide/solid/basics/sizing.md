...
::: sandpack {template=vite-solid showTabs=false editorHeight=300 editorWidthPercentage=60 dependencies="@ycloud-web/icons-solid"}

```tsx App.tsx [active]
import Landmark from '@ycloud-web/icons-solid/icons/landmark';
...
::: sandpack {template=vite-solid editorHeight=300 dependencies="@ycloud-web/icons-solid"}
...
```tsx App.tsx
import Beer from '@ycloud-web/icons-solid/icons/beer';
...
::: sandpack {template=vite-solid editorHeight=300 editorWidthPercentage=60 dependencies="@ycloud-web/icons-solid" externalResources="https://cdn.tailwindcss.com"}

```tsx App.tsx [active]
import PartyPopper from '@ycloud-web/icons-solid/icons/party-popper';
