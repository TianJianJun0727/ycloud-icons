---
title: With YCloud Lab or custom icons - Solid
description: Learn how to use YCloud Lab or custom icons in your Solid applications using the Icon component.
---
