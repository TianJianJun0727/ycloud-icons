---
title: With YCloud Lab or custom icons - Astro
description: Learn how to use YCloud Lab or custom icons in your Astro applications using the Icon component.
---
