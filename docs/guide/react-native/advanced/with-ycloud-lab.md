---
title: With YCloud Lab or custom icons - React Native
description: Learn how to use YCloud Lab or custom icons in your React Native applications using the Icon component.
---
