...
::: sandpack {template=vue showTabs=false editorHeight=400 editorWidthPercentage=60 dependencies="@ycloud-web/icons-vue"}
...
::: sandpack {template=vue showTabs=false editorHeight=480 editorWidthPercentage=60 dependencies="@ycloud-web/icons-vue"}
