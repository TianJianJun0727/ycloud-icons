...
::: sandpack {template=vue showTabs=false editorHeight=300 editorWidthPercentage=60 dependencies="@ycloud-web/icons-vue"}
...
::: sandpack {template=vue editorHeight=300 dependencies="@ycloud-web/icons-vue"}
...
::: sandpack {template=vue editorHeight=300 editorWidthPercentage=60 dependencies="@ycloud-web/icons-vue" externalResources="https://cdn.tailwindcss.com"}
