---
title: 颜色 - Svelte
description: 了解如何在 Svelte 应用中通过 `color` prop 或父元素文本颜色调整图标颜色。
---
...
<script>
import Smile from '@ycloud-web/icons-svelte/icons/smile';
</script>
...
```svelte src/App.svelte [active]
<script>
import ThumbsUp from "@ycloud-web/icons-svelte/icons/thumbs-up";
</script>
