...
<script>
import Scan from '@ycloud-web/icons-svelte/icons/scan';
import User from '@ycloud-web/icons-svelte/icons/user';
</script>
...
```svelte src/App.svelte [active]
<script>
import Mail from '@ycloud-web/icons-svelte/icons/mail';
...
```svelte src/App.svelte [active]
<script>
import File from '@ycloud-web/icons-svelte/icons/file';
</script>
