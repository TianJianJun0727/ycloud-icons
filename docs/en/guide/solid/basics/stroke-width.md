...
```tsx App.tsx [active]
import FolderLock from '@ycloud-web/icons-solid/icons/folder-lock';
...
::: sandpack {template=vite-solid showTabs=false editorHeight=320 editorWidthPercentage=60 dependencies="@ycloud-web/icons-solid"}

```tsx App.tsx [active]
import RollerCoaster from '@ycloud-web/icons-solid/icons/roller-coaster';
