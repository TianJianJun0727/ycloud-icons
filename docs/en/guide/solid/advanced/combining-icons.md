...
::: sandpack {template=vite-solid showTabs=false editorHeight=400 editorWidthPercentage=60 dependencies="@ycloud-web/icons-solid"}

```tsx App.tsx [active]
import Scan from '@ycloud-web/icons-solid/icons/scan';
import User from '@ycloud-web/icons-solid/icons/user';
...
You can also combine YCloud icons with native SVG elements to build custom icon variations.

### Example with notification badge

For example, you can add a notification badge to an icon by using the `circle` SVG element.

::: sandpack {template=vite-solid showTabs=false editorHeight=580 editorWidthPercentage=60 dependencies="@ycloud-web/icons-solid"}

```tsx App.tsx [active]
import Mail from '@ycloud-web/icons-solid/icons/mail';
...
```tsx App.tsx [active]
import File from '@ycloud-web/icons-solid/icons/file';
