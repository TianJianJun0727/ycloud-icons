...
description: Learn how to customize the stroke width of YCloud icons in your Astro applications using the strokeWidth and absoluteStrokeWidth props.
---
...
```astro
---
import FolderLock from '@ycloud-web/icons-astro/icons/folder-lock';
---
...
```astro
---
import RollerCoaster from '@ycloud-web/icons-astro/icons/roller-coaster';
---
