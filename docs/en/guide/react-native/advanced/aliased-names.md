...
description: Learn about the different import name styles available for YCloud icons in your React Native project and how to choose the one that best fits your needs.
---
...
| Prefixed     | YCloudHome                 | @ycloud-web/icons-react-native.prefixed |
| Suffixed     | HomeIcon                   | @ycloud-web/icons-react-native.suffixed |
