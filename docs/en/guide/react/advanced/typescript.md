...
```tsx
import { type YCloudProps } from '@ycloud-web/icons-react';
...
```tsx
import { type YCloudIcon } from '@ycloud-web/icons-react';
...
```tsx
import { type IconNode, Icon } from '@ycloud-web/icons-react';
