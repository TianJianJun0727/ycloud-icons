...
description: Learn how to style all YCloud icons globally in your Preact application using CSS or the YCloud context provider.
---
...
For global styling using a context provider, you can use the `YCloudProvider` component that is provided by the `@ycloud-web/icons-preact` package.
...
::: sandpack {editorHeight=400 editorWidthPercentage=60 dependencies="@ycloud-web/icons-preact"}
...
::: sandpack {editorHeight=480 editorWidthPercentage=60 dependencies="@ycloud-web/icons-preact"}
