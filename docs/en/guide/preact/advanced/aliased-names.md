...
import { House, HouseIcon, YCloudHouse } from '@ycloud-web/icons-preact';
```
...
{
  "js/ts.preferences.autoImportFileExcludePatterns": ["@ycloud-web/icons-preact"]
}
```
...
```ts [@ycloud-web/icons-preact.d.ts]
...
| Prefixed     | YCloudHome                 | @ycloud-web/icons-preact.prefixed |
| Suffixed     | HomeIcon                   | @ycloud-web/icons-preact.suffixed |
