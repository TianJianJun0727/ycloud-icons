...
description: Learn about the different types exported by the `@ycloud-web/icons-preact` package and how to use them in your Preact application.
---

# TypeScript

List of exported types from the `@ycloud-web/icons-preact` package.
...
```tsx
import { type YCloudProps } from '@ycloud-web/icons-preact';
