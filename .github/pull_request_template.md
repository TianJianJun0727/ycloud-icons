...
<!-- IMPORTANT! Please read our official statement on brand logos in YCloud: -->
<!-- https://github.com/TianJianJun0727/ycloud-icons/blob/main/BRAND_LOGOS_STATEMENT.md -->

- [ ] I have provided valid use cases for each icon.
- [ ] I have [not added any brand or logo icon](https://github.com/TianJianJun0727/ycloud-icons/blob/main/BRAND_LOGOS_STATEMENT.md).
...
- [ ] I've based them on the following YCloud icons: <!-- provide the list of icons -->
...
- [ ] I've read the [Contribution Guidelines](https://github.com/TianJianJun0727/ycloud-icons/blob/main/CONTRIBUTING.md).
