<script lang="ts">
  ...
  const { size = 24, width, height, alt = '', color = 'currentColor', strokeWidth, style, ...props }: DateTimeFilledProps = $props();
</script>
