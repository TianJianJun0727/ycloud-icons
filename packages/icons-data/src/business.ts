...
export const businessIconNames = ['billing', 'campaign', 'cart', 'chatbot', 'company', 'contact', 'ctwa', 'developers', 'help', 'home', 'inbox', 'integration', 'journey', 'logout', 'order', 'partner', 'pin', 'settings', 'whatsapp'] as const;
