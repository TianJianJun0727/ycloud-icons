...
export const emptyListIllustration: IllustrationDefinition = {
  ...
  node: [
    ...
    [
      'path',
      { d: 'm244.94 195.944-2.493 1.308-5.936-8.44 3.378-1.151 5.051 8.283Z', fill: '#FFBCA8' },
    ],
    [
      'path',
      {
    ...
    [
      'path',
      { d: 'm235.986 198.478-2.999-.375 3.964-6.803 3.965 1.322-4.93 5.856Z', fill: '#FFBCA8' },
    ],
    [
      'path',
      {
