export const callingFilledIcon = {
  name: 'calling-filled',
  colorMode: 'filled',
  attrs: {"xmlns":"http://www.w3.org/2000/svg","viewBox":"0 0 24 24","fill":"var(--business-icon-primary-color)"},
...
export default callingFilledIcon;
