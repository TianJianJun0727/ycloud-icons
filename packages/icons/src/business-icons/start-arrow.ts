export const startArrowSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 37 12" fill="currentColor">
  <path
...
`;
export const startArrowDataUri =
