...
import { Smile, Edit2, Pen } from '../src/ycloud-vue';
import createYCloudIcon from '../src/createYCloudIcon';
...
describe('Using ycloud icon components', () => {
  ...
  it('should add a class to the element', () => {
    ...
    expect(icon).toHaveClass('ycloud');
    expect(icon).toHaveClass('ycloud-smile-icon');
  });
