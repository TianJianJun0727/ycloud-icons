...
} from './illustration-icons/template-single-product-checkout.astro';
export {
...
} from './illustration-icons/template-whatsapp-order-details.astro';
export {
