...
export const integrationHubspotIllustration: IllustrationDefinition = {
  name: 'integration-hubspot',
  attrs: { xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 585.44 165.95' },
  node: [
    [
      'symbol',
      {
        ...
        [
          ...
          [
            ...
            [
              'clipPath',
              { transform: 'translate(0 0)' },
              [['rect', { fill: 'none', x: '376.04', width: '156.14', height: '163.62' }]],
            ],
          ],
        ],
        [
          ...
          [
            [
              'g',
              { fill: '#FE4802', 'clip-path': 'url(#clip-path)' },
              [
                [
                  'polygon',
                  {
                    points:
                      '63.4 27.47 63.4 74.28 20.41 74.28 20.41 27.47 0 27.47 0 139.21 20.41 139.21 20.41 93.92 63.4 93.92 63.4 139.21 83.81 139.21 83.81 27.47 63.4 27.47',
                  },
                ],
                [
                  'path',
            ...
            [
              'g',
              { fill: '#FE4802', 'clip-path': 'url(#clip-path-2)' },
              [
                [
                  'path',
                  {
...
export default integrationHubspotIllustration;
