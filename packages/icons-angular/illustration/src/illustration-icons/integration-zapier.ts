...
export const integrationZapierIllustration: IllustrationDefinition = {
  ...
  node: [
    ['rect', { y: '0.556641', width: '104.117', height: '28', fill: 'url(#pattern0_19972_8410)' }],
    [
      'defs',
      {},
      [
        [
          ...
          [
            [
              'use',
              { 'xlink:href': '#image0_19972_8410', transform: 'scale(0.00261097 0.00970874)' },
            ],
          ],
        ],
        [
...
export default integrationZapierIllustration;
