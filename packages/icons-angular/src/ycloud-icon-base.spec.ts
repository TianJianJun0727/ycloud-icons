...
import { provideYCloudConfig } from './ycloud-config';
...
@Component({
  selector: 'svg[ycloudCircleCheck], svg[ycloudCheckCircle2]',
  template: ycloudIconTemplate,
  standalone: true,
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class YCloudCircleCheck extends YCloudIconBase {
  static readonly icon: YCloudIconData = {
    name: 'circle-check',
    size: 24,
    node: [
  ...
  protected override readonly icon = signal(YCloudCircleCheck.icon);
}

describe('YCloudIconBase', () => {
  let component: YCloudCircleCheck;
  let fixture: ComponentFixture<YCloudCircleCheck>;
  ...
  function createComponent() {
    return TestBed.createComponent(YCloudCircleCheck, {
      inferTagName: true,
      bindings: [
