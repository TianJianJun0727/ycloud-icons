export const taskMenuFilledIcon = {
  name: 'task-menu-filled',
  colorMode: 'filled',
  attrs: {
  ...
  node: [
    [
      'g',
      { 'clip-path': 'url(#clip0_7774_12737)' },
      [
        [
          'path',
          {
    ...
    [
      ...
      [
        [
          'clipPath',
          { id: 'clip0_7774_12737' },
          [['rect', { width: '24', height: '24', fill: 'var(--business-icon-primary-color)' }]],
        ],
      ],
    ],
  ],
...
export default taskMenuFilledIcon;
