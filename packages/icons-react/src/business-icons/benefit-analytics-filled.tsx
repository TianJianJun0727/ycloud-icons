...
type BenefitAnalyticsFilledProps = BusinessIconImageProps & {
  secondaryColor?: string;
};

const BenefitAnalyticsFilled = forwardRef<SVGSVGElement, BenefitAnalyticsFilledProps>(
  (
    {
      size = 24,
      width,
