...
const WaitingStatus = forwardRef<SVGSVGElement, IllustrationProps>(
  ({ width = '100%', height = 'auto', alt = '', ...props }, ref) => (
    ...
    >
      ...
      <path fillRule="evenodd" clipRule="evenodd" d="M210.893 194.561h4.17l10.277-4.17s7.298-3.089 6.702 2.78c-.596 5.87-1.638 13.747-1.638 13.747s-3.277-1.545-5.064-1.081c-1.788.463-.596-9.422-.596-9.422s-14.596 7.259-15.936 6.333c-1.341-.927-1.639-7.414-1.639-7.414l3.724-.773Z" fill="url(#t)" />
      <path fillRule="evenodd" clipRule="evenodd" d="M210.774 174.305c.257-1.578.912-2.151 1.963-1.721 1.651.675 3.178-1.513 3.895-3.757 1.458-4.564 1.369-5.857-.711-6.707-2.079-.851-4.31-1.644-5.696.666-1.386 2.309-2.093 3.738-2.253 5.644-.16 1.906-1.646 3.559-2.346 3.809-.466.167 1.25.855 5.148 2.066Z" fill="url(#u)" />
      <path fillRule="evenodd" clipRule="evenodd" d="M207.602 169.94c1.005-3.754-.634-7.168.445-8.942.719-1.183 1.521-1.564 2.404-1.145 1.574-2.106 3.398-2.296 5.474-.568.521.434.976.775 1.612.944 1.139.303 1.039.33 1.774.655.966.428 1.389 1.058 1.468 1.888.097 1.02-1.034 2.304-2.136 2.304-1.406 0-1.589-.499-2.468-.496-.588.002-1.799.845-3.63 2.529l.082-.691c.069-1.408-.301-2.084-1.111-2.029-.809.055-1.197.631-1.165 1.728-.032 1.328-.234 2.314-.605 2.958-.37.645-1.085.933-2.144.865Z" fill="#353564" />
      ...
      <path fillRule="evenodd" clipRule="evenodd" d="m235.064 181.19-5.589 4.212c.867 1.493 1.429 2.18 1.687 2.063.387-.177 6.756-4.03 6.756-4.03l-2.854-2.245Z" fill="#5B5BEA" />
      <path fillRule="evenodd" clipRule="evenodd" d="M234.83 181.735c-.09.018-1.698 1.22-4.823 3.608.68.976 1.036 1.508 1.07 1.596.05.132 5.978-3.553 5.978-3.554 0 0-2.09-1.676-2.225-1.65Z" fill="#F9F9F9" />
      ...
      <path fillRule="evenodd" clipRule="evenodd" d="m209.063 197.021 1.788 2.855 10.674-3.385a8.334 8.334 0 0 1 6.987.85c1.863 1.183 3.056 3.06.373 5.839-5.365 5.558-8.942 2.554-8.942 2.554s-18.034 8.563-21.015 4.356c-2.981-4.206-3.13-6.309-3.13-6.309s11.476-7.21 13.265-6.76Z" fill="url(#v)" />
      ...
      <path fillRule="evenodd" clipRule="evenodd" d="M205.396 171.757a1.74 1.74 0 0 1 .909.002c.943.255 3.059.93 3.512 1.958.588 1.332 2.646 3.403 2.646 3.403s2.793 2.812 2.205 4.736c-.588 1.923-2.793 4.143-2.793 4.143s.182 9.258-1.764 11.967c-1.945 2.709-12.378 7.924-14.112 7.27-1.734-.654-2.006-4.561-1.734-8.318.272-3.756.986-22.396 11.131-25.161Z" fill="#5B5BEA" />
      <path fillRule="evenodd" clipRule="evenodd" d="M210.059 175.357s9.436 6.994 7.734 9.948c0 0-5.723 2.797-6.961 2.642-1.237-.156-6.033-5.596-7.27-6.062-1.238-.466-1.857-8.859 6.497-6.528Z" fill="#6464F0" />
      ...
      <defs>
        ...
        <linearGradient id="c" x1="129.034" y1="195.488" x2="129.034" y2="103.874" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FCFCFC" stopOpacity=".331" />
          <stop offset="1" stopColor="#EEEEF6" />
        </linearGradient>
        <linearGradient id="d" x1="159.173" y1="208.252" x2="159.173" y2="125.373" gradientUnits="userSpaceOnUse">
          <stop stopColor="#EEEEF7" stopOpacity="0" />
        ...
        <linearGradient id="h" x1="249.752" y1="196.541" x2="249.752" y2="88.594" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FBFBFF" stopOpacity="0" />
          <stop offset="1" stopColor="#FDFDFF" />
        </linearGradient>
        ...
        <linearGradient id="v" x1="203.784" y1="204.982" x2="207.933" y2="198.826" gradientUnits="userSpaceOnUse">
          <stop stopColor="#7575CE" />
          <stop offset="1" stopColor="#7171D8" />
        </linearGradient>
        <linearGradient id="y" x1="111.013" y1="76.52" x2="111.013" y2="115.222" gradientUnits="userSpaceOnUse">
          <stop stopColor="#DCDCE4" />
          <stop offset="1" stopColor="#DEDEE6" stopOpacity="0" />
        </linearGradient>
        <radialGradient id="w" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="rotate(-120.103 114.607 32.227) scale(14.4911 11.1521)">
          <stop stopColor="#F8B837" />
          <stop offset="1" stopColor="#FFDE9B" />
        </radialGradient>
        <radialGradient id="x" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="matrix(-2.81346 -4.85288 3.84943 -2.2317 261.4 180.463)">
          <stop stopColor="#F8B837" />
          <stop offset="1" stopColor="#FFDE9B" />
        </radialGradient>
      </defs>
