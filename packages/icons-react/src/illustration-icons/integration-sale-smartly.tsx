...
const IntegrationSaleSmartly = forwardRef<SVGSVGElement, IllustrationProps>(
  ({ width = '100%', height = 'auto', alt = '', ...props }, ref) => (
    ...
    >
      ...
      <defs>
        ...
        >
          <use
            xlinkHref="#image0_19972_14745"
            transform="scale(0.001321 0.00763359)"
          />
        </pattern>
        <image
...
IntegrationSaleSmartly.displayName = 'IntegrationSaleSmartly';

export default IntegrationSaleSmartly;
