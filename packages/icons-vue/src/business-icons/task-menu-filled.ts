...
type TaskMenuFilledProps = BusinessIconImageProps & {
  secondaryColor?: string;
};

const TaskMenuFilled: FunctionalComponent<TaskMenuFilledProps> = ({ size = 24, width, height, alt = '', color = 'currentColor', strokeWidth, style, ...props }) =>
  h(
    'svg',
    {
