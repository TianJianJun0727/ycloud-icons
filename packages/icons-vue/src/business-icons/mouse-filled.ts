...
type MouseFilledProps = BusinessIconImageProps & {
  secondaryColor?: string;
};

const MouseFilled: FunctionalComponent<MouseFilledProps> = ({ size = 24, width, height, alt = '', color = 'currentColor', strokeWidth, style, ...props }) =>
  h(
    'svg',
    {
