...
type CompassFilledProps = BusinessIconImageProps & {
  secondaryColor?: string;
};

const CompassFilled = ({ size = 24, width, height, alt = '', color = 'currentColor', strokeWidth, style, ...props }: CompassFilledProps) => (
<svg
