...
type BillingFilledProps = BusinessIconImageProps & {
  secondaryColor?: string;
};

const BillingFilled = ({ size = 24, width, height, alt = '', color = 'currentColor', strokeWidth, style, ...props }: BillingFilledProps) => (
<svg
