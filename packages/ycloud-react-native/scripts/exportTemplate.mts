 ...
 * @see https://tianjianjun0727.github.io/ycloud-icons/guide/packages/ycloud-react-native - Documentation
 *
 * @param {Object} props - YCloud icons props and any valid SVG attribute
 * @returns {JSX.Element} JSX Element
 * ${deprecated ? `@deprecated ${deprecationReason}` : ''}
 */
const ${componentName} = createYCloudIcon('${componentName}', ${JSON.stringify(children)});
