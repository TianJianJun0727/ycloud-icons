...
- `filled`: use the single primary business color token; render internal details as transparent
  compound-path cutouts instead of white, additional-color, or same-color overlay shapes
